...
if(isset($_POST["submit"])){
  if($_POST["id"] == ""){
    saveUser($_POST["email"],$_POST["password"],$_POST["firstname"],$_POST["lastname"],$_POST["telephone"],$_POST["positions"],$_POST["faculties"],$_POST["majors"],$_FILES["profile_img"]["name"]);
  }else{
    editUser($_POST["id"],$_POST["email"],$_POST["password"],$_POST["firstname"],$_POST["lastname"],$_POST["telephone"],$_POST["positions"],$_POST["faculties"],$_POST["majors"],$_FILES["profile_img"]["name"]);
  }
