...
if (isset($_GET['confirm'])) {
  updateProcedureActivity($_GET['confirm']);
}

if(isset($_POST["submit"])){
  updateLinkActivity($_POST["id"],$_POST["link_budget"],$_POST["link_summary"]);
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
      ...
      <form name="prduct_detail_form" action="" method="post" enctype="multipart/form-data">
        <input type="hidden" class="form-control" name="id" value="<?php echo $currentDataActivity["aid"];?>">
        <div class="row">
          <div class="col-md-8">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-8">
                    <div class="form-group">
                      <input type="text" class="form-control" name="link_budget" required>
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-md-8">
                    <div class="form-group">
                      <input type="text" class="form-control" name="link_summary" required>
                    </div>
                  </div>
                </div>
                        ...
                        <tr>
                          ...
                          <td style="width:20%;text-align:center;">
                            <?php if($_SESSION["role"] == 1){?>
                              <?php if($data["procedure_status"] == 1){ ?>
                                <a href="?confirm=<?php echo $data['id'];?>" class="btn btn-success" onClick="javascript: return confirm('ยืนยันผลดำเนินการ');">ดำเนินการเรียบร้อย</a>
                              <?php } ?>
                            <?php } ?>
                          </td>
