...
*/
$files = "แผนปฏิรูปงบประมาณประจำปี.xls";
header("Content-type: application/octet-stream");
            ...
            <?php }else{?>
              <?php foreach($allProjectInStrategiesId as $dataPro){ ?>
                ...
                <tr>
                  ...
                  <td ><?php echo $dataPro["agency"];?></td>
                  <td ><?php echo $dataPro["course"];?></td>
                ...
                <?php }else{?>
                  <?php foreach($allActivityInProject as $dataAct){ ?>
                    ...
                    <tr>
                      ...
                      <td ><a href="https://docs.google.com/document/d/1uvraE-EY26MrBol1D81x3WTYLskCEhOKTy3rbC5tldw/edit?usp=sharing">ดาวน์โหลด</a>
                            <br/><a href="https://docs.google.com/document/d/1uvraE-EY26MrBol1D81x3WTYLskCEhOKTy3rbC5tldw/edit?usp=sharing">ดาวน์โหลด</a>
                            <br/><a href="https://docs.google.com/document/d/1uvraE-EY26MrBol1D81x3WTYLskCEhOKTy3rbC5tldw/edit?usp=sharing">ดาวน์โหลด</a>
                      </td>
                      <td ><a href="https://docs.google.com/document/d/1uvraE-EY26MrBol1D81x3WTYLskCEhOKTy3rbC5tldw/edit?usp=sharing" >ดาวน์โหลด</a></td>
                    </tr>
                  <?php } ?>
                <?php } ?>
              <?php } ?>
